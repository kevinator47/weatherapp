...
function WeatherPropsList(){
  ...
  return(
    ...
    >
      <WeatherPropCard propName="Visibility" propValue={currentWeather?.visibility} propIcon={<VisibilityIcon/>} />
      <WeatherPropCard propName="Humidity" propValue={currentWeather?.main.humidity} propMeasureUnit="%" propIcon={<HumidityIcon/>} />
      <WeatherPropCard propName="Wind Speed" propValue={Math.round(currentWeather?.wind.speed)} propMeasureUnit="km/h" propIcon={<WindSpeedIcon/>} />
      <WeatherPropCard propName="Air Pressure" propValue={currentWeather?.main.pressure} propMeasureUnit="hPa" propIcon={<AirPressureIcon/>} />
      <WeatherPropCard propName="Sunrise" propValue={getTimeWithMinutes(currentWeather?.sys.sunrise)} propIcon={<SunriseIcon/>} />
      <WeatherPropCard propName="Sunset" propValue={getTimeWithMinutes(currentWeather?.sys.sunset)} propIcon={<SunsetIcon/>} />
    </div>
  );
};
